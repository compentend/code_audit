...
class StartupWindow(QWidget):
    ...
    def initUI(self):
        ...
        pixmap = QPixmap('resource/icon/start.png')  # 替换为你的图片路径
        ...
        # 添加动态文字
        self.text_label = QLabel("欢迎来到代码审计系统", self)
        self.text_label.setFont(QFont("Arial", 20, QFont.Bold))
        self.text_label.setStyleSheet("color: #4C566A;")
        self.text_label.setAlignment(Qt.AlignCenter)
        layout.addWidget(self.text_label)

        self.button = QPushButton('点击以继续')
        ...
        self.button.setStyleSheet("""
                ...
                """)
        self.button.clicked.connect(self.fade_out)
    ...
    def fade_in(self):
        ...
        self.image_label.setGraphicsEffect(self.effect)
    ...
    def fade_out(self):
        ...
        self.animation.finished.connect(self.close_and_open_main)
        self.animation.start()

    def text_animation(self):
        self.text_effect = QGraphicsOpacityEffect()
        self.text_label.setGraphicsEffect(self.text_effect)
        self.text_animation = QPropertyAnimation(self.text_effect, b"opacity")
        self.text_animation.setDuration(2000)  # 动画持续时间2秒
...
class MyWindow(QMainWindow, Ui_MainWindow):
    ...
    def setup(self):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(".\\resource\\icon\\Export.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(".\\resource\\icon\\pie.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    #直接遍历标签页会导致没被处理的标签页索引改变，采用倒序遍历解决
    def fileCloseAll(self):
        failures = []
        self.tabWidget_2.setCurrentIndex(0)

        # 倒序遍历标签页，确保每次移除标签页时不会影响未遍历到的标签页的索引
